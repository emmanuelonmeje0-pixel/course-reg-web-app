...
export default function StudentView({cgpa, student, setSelectedCourse, setOpenDialog, courseData}: IProps) {
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        {/* GPA Card */}
        <div className="bg-linear-to-r from-indigo-900 to-blue-700 rounded-xl p-6 text-white">
